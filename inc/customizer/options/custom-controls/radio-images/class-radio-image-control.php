...
// Exit if circle_Radio_Image_Control exists & WP_Customize_Control not exsist.
if (class_exists('circle_Radio_Image_Control') && !class_exists('WP_Customize_Control')) {
    return null;
}
...
if (class_exists('WP_Customize_Control')) {
    ...
    class circle_Radio_Image_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style('circle-radio-image-control-css', get_parent_theme_file_uri('inc/customizer/options/custom-controls/radio-images/radio-image.css', array() , '1.0', 'all'));
        }
